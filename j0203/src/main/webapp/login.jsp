			...
			<div id="contents">
				<div id="member">
					...
					<div class="informbox">
						<div class="inform">
							<ul>
								<form action="./logChk.jsp"name='frm' method='get'>
							...
							<div class="btn"><a onclick="javascript:frm.submit();" class="sbtn">로그인</a></div>
							<div class="chk"><input type="checkbox" id="idsave" name="saveId" value="saveId"><label for="idsave">아이디 저장</label></div>							
							</form>
